						   ...
						   IN OUT PVOID CallbackContext)
{
	...
	TYPEOF_ZwReadVirtualMemory *pZwReadVirtualMemory=(TYPEOF_ZwReadVirtualMemory *)GetProcAddress(hNTDLL,"ZwReadVirtualMemory");
	TYPEOF_ZwQueryInformationProcess *pZwQueryInformationProcess=(TYPEOF_ZwQueryInformationProcess *)GetProcAddress(hNTDLL,"ZwQueryInformationProcess");
	...
	else
	{
		...
		Status = (*pZwQueryInformationProcess)(ProcessHandle,
		...
		Status = (*pZwReadVirtualMemory)(ProcessHandle,
